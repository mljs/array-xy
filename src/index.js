...
} from '../packages/ml-array-xy-centroids-merge/src';
export { default as closestX } from '../packages/ml-arrayxy-closestx/src';
...
export { default as uniqueX } from '../packages/ml-arrayxy-uniquex/src';
export { default as filterX } from '../packages/ml-array-xy-filter-x/src';
export {
  default as equallySpaced
} from '../packages/ml-array-xy-equally-spaced/src';
export {
  default as weightedMerge
} from '../packages/ml-array-xy-weighted-merge/src';
